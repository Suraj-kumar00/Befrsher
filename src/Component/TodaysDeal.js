...
function TodaysDeal() {
  return (
    <section className='ml-[0.94rem] mr-[4.06rem] mb-10 max-w-screen  max-h-[34.1875rem] flex flex-col gap-6 2xl:gap-4 xl:gap-3 lg:gap-2 md:gap-1 sm1:ml-[0.2rem] flex-shrink 4xl:w-screen border-2 border-red-400'>
            ...
            {/* <div className='relative rounded-[1.25rem] max-h-[50.125rem] max-w-full border-2 border-red-500 ' >
                <img className=" relative w-screen max-h-full w-auto h-auto  4xl:w-screen " src={TodaysDealImg}alt="TodaysDealImage"/>
            ...
            <div className=' rounded-[1.25rem] max-h-[50.125rem] max-w-full border-2 border-red-500  ' >
