  ...
  return (
    <section className='ml-[0.94rem] mr-[4.06rem] mb-10 w-[89.5rem] h-[34.1875rem] flex flex-col gap-6'>
            ...
            <div className='relative rounded-[1.25rem] h-[30.125rem] w-[89.5rem]'>
                ...
                <div className='absolute bottom-[1.56rem] right-[9.12rem] left-[56.62rem] top-[24.81rem] rounded-[0.625rem] bg-[#484FA2] text-white text-[2.3125rem] font-semibold tracking-tighter text-center'><a className='flex justify-center items-center' href="#">Explore</a></div>
            </div>
