...
function BecomeSeller() {
  return (
    <div className='w-[89.5rem] h-[35.875rem] pr-12 pb-8 ml-[0.94rem] mr-[4.06rem] mb-10 border-2 border-yellow-300'>
            <h1 className="text-[2.3125rem] text-[#1f1f1f] font-semibold tracking-tighter]">Become a Seller</h1>
            <div className="h-[30.125rem] flex border-4 border-green-500  rounded-[1.25rem]">
                    <img className="border-4 border-red-700 rounded-[1.25rem]"src={BecomeSellerBanner} alt="become seller banner"/>
                    <div className="flex flex-col  justify-center  border-2 border-black ml-10">
