...
function TrendNearrYou() {
  return (
    <section className='ml-[0.94rem] mr-[4.06rem] mb-10   4xl:w-screen  max-h-[34.1875rem] flex flex-col gap-6 sm2:gap-1 sm1:gap-1 md:gap-1.5 2xl:gap-2 flex-shrink flex-nowrap w-full md:ml-[0.4rem] lg:ml-[0.5rem] xl:ml-[0.7rem] '>
            ...
            <div className='relative rounded-[1.25rem] max-h-[30.125rem] max-w-full w-full  border-2 border-green-500  flex flex-shrink '>
