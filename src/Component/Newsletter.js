...
export const Newsletter = () => {
  return (
    <section className="max-h-[29.8125rem] max-w-full w-full flex flex-col justify-center items-center ml-10 mr-[2.5625rem]  border-green-800 border-2 w-screen mt-1 4xl:m-2 "> 
            <h1 className=' font-medium -tracking-[0.0625rem] text-[#1f1f1f] border-2 mt-1 p-2 flex items-center border-black h-[6.25rem] text-[3.125rem] md:text-[2.5rem] lg:text-[3rem] sm:text-[1.8rem] text-center leading-7  mb-[1.5rem] '>Get 25% off on your first order</h1>
