...
function InstagramComp() {
  return (
    <section className='flex sm1:flex-col   sm:gap-4  justify-center 4xl:justify-around  w-screen sm:p-1 md:p-2 lg:p-6 items-center  max-h-[25rem] lg:max-h-[] py-[3.875rem] pr-[6.0625rem] pl-[7.625rem]  gap-[6.9375rem] md:gap-2 lg:gap-3 2xl:gap-10 4xl:gap-0 rounded-[0.625rem] mb-[2.69rem] ml-[0.94rem] lg:m-1 xl:m-2 xl:p-8 2xl:p-8 4xl:p-7 4xl:m-2 2xl:m-2 sm:ml-1 mr-[4.13rem]  bg-[#f4f4f4] '>
           <div className='flex justify-center items-center    max-h-[8.9197rem]  rounded-[0.625rem] sm:w-[50%] sm1:w-full sm:ml-[0.01rem] md:max-h-[12rem] lg:max-h-64 xl:max-h-96  m1:max-h-[15rem] 2xl:max-h-[28rem] 4xl:max-h-[28rem] ' >
            ...
            <div className="flex flex-col justify-center items-center rounded-[0.625rem] max-w-[31.25rem] sm1:w-full max-h-[10.75rem] lg:max-h-64 xl:max-h-80 bg-[#f4f4f4] border-2 border-green-500">
                ...
                <h1 className="flex justify-center items-center max-w-[31.25rem] sm:p-0 text-[2.5rem] sm:text-[1.5rem] font-medium tracking-tighter leading-9 sm:leading-6 text-[#1F1F1F] text-center border-2 border-red-500 p-2">Join us on instagram</h1>
            </div>
