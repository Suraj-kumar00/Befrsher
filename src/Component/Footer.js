...
function Footer() {
  return (
    <footer className="w-1512 h-80 bg-[#F4F4F4] border-2 border-red-700 flex justify-center flex-col items-center text-[#1F1F1F]">
            <div className='w-[89.5rem] h-[11.5rem] flex items-center justify-between border-2 border-green-600 mx-10 mb-[1.6875rem] mt-6'>
            ...
            <div className=' border-2 border-yellow-900 w-[24.25rem] h-16 flex justify-center items-center  gap-[1.6875rem] py-[0.9375rem] ml-[31.3125rem] mr-[38.9375rem] mb-[1.3125rem]'>
