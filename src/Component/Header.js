...
function Header() {
  return (
    <main className='flex max-w-screen flex-grow flex-shrink w-full border-black border-2 h-60 pt-3 pb-2 pr-[2.5625rem] pl-10 lg:p-1'>
        ...
        <div className="flex flex-shrink justify-evenly items-center max-w-screen w-full border-4 border-yellow-400 ">
            <div className='flex flex-shrink items-center justify-around lg:max-w-[15rem] h-[1.6875rem] 2xl:max-w-[21.3125rem] w-full border-4 border-red-800'>
